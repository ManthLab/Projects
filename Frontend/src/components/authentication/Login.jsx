      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          {loading ? (
            ...
            <button
              className="block w-3/4 py-3 my-3 text-white  items-center justify-center max-w-7xl mx-auto
          ...
          <div>
            <p className="text-gray-700 text-center my-2">
              ...
              <Link to="/register" className="text-blue-700">
                <button
                  className="block w-1/2 py-3 my-3 text-white  items-center justify-center max-w-7xl mx-auto
